	...
	$.fn.databar = function (options) {
		...
		var colorMaker = (function () {
			...
			var colors = [
				...
				'rgba(59, 89, 152, ' + backgroundOpacity + ')',   // '#cb4b16',
				'rgba(85, 172, 238, ' + backgroundOpacity + ')',   // '#dc322f',
				'rgba(0, 123, 181, ' + backgroundOpacity + ')',  // '#d33682',
				'rgba(224, 47, 47, ' + backgroundOpacity + ')', // '#6c71c4',
